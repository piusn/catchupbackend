        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberId = table.Column<int>(type: "int", nullable: false),
                    UserAvailabilityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInterests_UserAvailability_UserAvailabilityId",
                        column: x => x.UserAvailabilityId,
                        principalTable: "UserAvailability",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserInterests_Users_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInterests_MemberId",
                table: "UserInterests",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInterests_UserAvailabilityId",
                table: "UserInterests",
                column: "UserAvailabilityId");
